    ...
    move(moveIndex) {
        ...
        this.beatmapSet.map((beatmap, index) => {
            ...
            if (index < this.revealed+moveIndex+1) {
                ...
                pickOverlay.style.backgroundImage = "linear-gradient(to right, rgba(220, 163, 158,0.5) ,rgba(220, 163, 158,0.5))";
                pickSource.style.opacity = 1;
            } else {
                pickName.style.opacity = 0;
                pickOverlay.style.backgroundImage = "linear-gradient(to right, rgba(220, 163, 158,1) ,rgba(220, 163, 158,0))";
